                    ...
                    <form action="admin/Product/edit/<?php echo $product['id'] ?>" method="POST" role="form">
                        ...
                        <div class="form-group">
                            <select name="id_category" class="form-control">
                                ...
                                <option
                                    value="<?php echo $value['id'] ?>" <?php echo $value['id'] == $product['id_category'] ? 'selected' : ''; ?>><?php echo $value['name'] ?></option>
                                <?php endforeach ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="label" placeholder="Apple, Samsung, LG,..."
                                   required value="<?php echo $product['label'] ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <img width="200px" src="uploads/product/<?php echo $product['image'] ?>" alt="Lỗi">
                        ...
                        <div class="form-group">
                            <select name="id_promotion" class="form-control">
                                ...
                                <option
                                    value="<?php echo $value['id'] ?>" <?php echo $value['id'] == $product['id_promotion'] ? 'selected' : ''; ?>><?php echo $value['name'] ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control">
                                <option value="1" <?php echo $product['status'] == 1 ? 'selected' : ''; ?>>Hiển thị
                                </option>
                                <option value="2" <?php echo $product['status'] == 2 ? 'selected' : ''; ?>>Không hiển
                                    thị
                                </option>
                        ...
                        <button type="submit" class="btn btn-primary btn-block" style="margin-bottom: 20px;">Cập nhật
                        </button>
                    </form>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <table class="table table-striped table-bordered table-hover">
                   ...
                   print_r($cmt['status']);
                   print_r($cmt['id']);
                   print_r($cmt['time_created']); -->
                    <?php $i = 1 ?>
                    <?php foreach($comt as $key => $value ) :?>

                    <?php  foreach($value as $cmt):?>
                    <?php
                    $cmt = (array)$cmt;
                    ...
                    <tr class="odd gradeX" align="center">
                        ...
                        <td><?php echo date("d/m/Y", $cmt['time_created']); ?></td>
                        <td>
                            <?php $status = $cmt['status'] == 1 ? 'Đã kiểm duyệt' : 'Chưa kiểm duyệt' ?>
                            ...
                            <div class="change_status kHThi">
                                ...
                                <input type="hidden" value="<?php echo $cmt['id'] ?>" class="idOrder">
                            </div>
                        </td>
                        ...
                        <input type="hidden" value="<?php echo $cmt['id'] ?>">
