            ...
            <div class="row">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr class="odd gradeX" align="center">
                        ...
                        <td>
                            <img class="responsive-image" width="80px"
                                 src="uploads/product/<?php echo $value['image']; ?>" alt="Error">
                        </td>
                        <td>
                        ...
                        <td class="center"><i class="fa fa-pencil fa-fw"></i> <a
                                href="admin/Product/edit/<?php echo $value['id'] ?>">Edit</a></td>

                        <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a
                                href="admin/Product/delete/<?php echo $value['id'] ?>">Delete</a></td>
                    </tr>
                    <?php $i = $i + 1 ?>
