            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <form action="admin/Product/add" method="POST" role="form" validate enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Giá</label>
                            <input type="number" class="form-control" name="price_origin" placeholder="Giá gốc"
                                   required>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary btn-block" style="margin-bottom: 20px;">Thêm mới
                        </button>
                    </form>
                </div>
