                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <table class="table table-striped table-bordered table-hover table-responsive">
                        ...
                        <tr class="odd gradeX" align="center">
                            ...
                            <th style="max-width: 150px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;"
                                class="text-center"><?php echo $value['phone']; ?></th>
                            <?php// if ($type=='Quản trị viên'): ?>
                            <th class="text-center">
                                <?php if ($value['level'] == 1) echo "Nhân viên"; ?>
                                <?php if ($value['level'] == 2) echo "Admin"; ?>
                                <?php if ($value['level'] == 0) echo "Client"; ?>
                            </th>
                            <?php// endif ?>
                            <th class="text-center">
                            ...
                            <td class="center"><i class="fa fa-pencil fa-fw"></i> <a
                                    ...
                                    <?php //} ?>
                                    href="admin/User/editByID/<?php echo $value['id'] ?>/<?php echo $value['level'] ?>">Edit</a>
                            </td>
                            <td class="center"><i class="fa fa-pencil fa-fw"></i> <a
                                    <?php //if($this->session->userdata('level') != 2){?>
                                    style="pointer-events: none;"
                                    <?php //} ?>
                                    href="admin/User/delete/<?php echo $value['id'] ?>/<?php echo $value['level'] ?>">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                        <?php endforeach ?>
