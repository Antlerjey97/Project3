        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-8 col-lg-push-2" style="padding-bottom:120px">
                    ...
                    <?php $this->session->unset_userdata($status); ?>
                    <?php endif ?>
                    <form action="admin/User/updateInfoUser/<?php echo $user['id'] ?>" method="POST"
                          enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Tên tài khoản</label>
                            <input style="pointer-events: none;" disabled class="form-control"
                                   value="<?php echo $user['username'] ?>" name="username"/>
                        </div>
                        <div class="form-group">
                            <label>Tên người dùng</label>
                            <input class="form-control" value="<?php echo $user['fullname'] ?>" name="fullname"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="<?php echo $user['phone'] ?>" name="phone"
