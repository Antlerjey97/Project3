        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-8 col-lg-push-2" style="padding-bottom:120px">
                    ...
                    <form
                        action="admin/User/updateStatusCustomer/<?php echo $user['id'] ?>/<?php echo $user['level'] ?>"
                        method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Tên tài khoản</label>
                            <input style="pointer-events: none;" class="form-control"
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input style="pointer-events: none;" class="form-control" type="email"
                                   value="<?php echo $user['email'] ?>" name="email" placeholder="Nhập email" disabled/>
                        </div>
                        <div class="form-group">
