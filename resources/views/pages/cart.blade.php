...
<div class="row">
    <div class="listProductBuy">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                            <div class="anh">
                                <a href="/Home/singleProduct/<?php //echo $value['id_category'] ?>/<?php// echo $value['id'] ?>"><img
                                        width="100px" src="<?php //echo $value['image'] ?>" alt="Lỗi"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                    <div class="quantitySale">
                        <div class="btn-group">
                            ...
                            <input type="text" id="sl_add" class="btn btn-default"
                                   value="<?php //echo $cart[$value['id']][0] ?>">
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 inforChecked">
            ...
            <hr>
            <h5>Tổng cộng <span id="priceEnd"
                                style="color:#F57224;font-weight:bold;"><?php //echo number_format($priceEnd,0,".", "."); ?> ₫</span>
            </h5>
            <hr>
