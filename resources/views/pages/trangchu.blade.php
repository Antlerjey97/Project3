...
<div class="phone">
	<div class="container">
      ...
      <div class="row">
		<div class="viewMore">
			<a class="btn btn-danger" href="pages/showproduct/<?php echo $header[0]['id'] ?>">Xem thêm <?php echo $header[0]['name'] ?></a>
		</div>
	</div>
	</div>
</div> <!-- end phone -->
...
<div class="tablet">
	<div class="container">
       ...
       <div class="row">
			<div class="viewMore">
				<a class="btn btn-danger" href="pages/showproduct/<?php echo $header[1]['id'] ?>">Xem thêm <?php echo $header[1]['name'] ?></a>
			</div>
	   </div>
	</div>
</div> <!-- end tablet -->
...
<div class="laptop">
	<div class="container">
       ...
       <div class="row">
		<div class="viewMore">
			<a class="btn btn-danger" href="pages/showproduct/<?php echo $header[2]['id'] ?>">Xem thêm <?php echo $header[2]['name'] ?></a>
		</div>
	</div>
	</div>
</div> <!-- end laptop -->
...
<div class="accessories">
	<div class="container">
       ...
       <div class="row">
		<div class="viewMore">
			<a class="btn btn-danger" href="pages/showproduct/<?php echo $header[3]['id'] ?>">Xem thêm <?php echo $header[3]['name'] ?></a>
		</div>
	</div>
	</div>
</div> <!-- end phone -->
