    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                <div class="avatar">
                    <a href=""><img src="/uploads/product/<?php echo $value['image'] ?>" alt="Lỗi"></a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                <div class="content">
            ...
            <div class="row">
                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 cmtProduct">
                    ...
                    <div class="contentCmtMe">
                        <textarea style="resize: vertical;" name="cmtMe" cols="106" rows="5" style="resize:none"
                                  id="cmtMe"></textarea>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                <div class="product">
                    <a href="/project2/Home/singleProduct/<?php echo $value['id_category'] ?>/<?php echo $value['id'] ?>"><img
