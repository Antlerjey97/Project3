...
class ProductController extends Controller
{
    ...
    public function getsua($id){
      ...
      $comt = DB::table('comment')
            ->select('comment.content', 'comment.id', 'comment.status','comment.time_created','comment.user_id','users.username')
        ...
        return view('admin.product.edit',['product'=>$product,'promotion'=>$promotion,'category'=>$category,'comt'=>$comt]);
